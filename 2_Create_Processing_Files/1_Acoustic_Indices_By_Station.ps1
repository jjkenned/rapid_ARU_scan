...
<<<<<<< HEAD
$transect = "MKVI-21" # station to station basis at this point
=======
...
<<<<<<< HEAD
$output_directory = "$base_parent_out\PMRA_SAR\Recordings\BIRD\$year\$region\$transect" # output directory 
=======
...
foreach ($input_directory in $input_directories) {
    ...
    C:\AP\AnalysisPrograms.exe ConcatenateIndexFiles `
        ...
        --output-directory "$output_directory/by_night/$current_group" `
        -z $time_zone_offset `
